'use client';
// src/app/thrive/assessments/[id]/page.tsx

import React from 'react';
import { useRouter, useParams } from 'next/navigation';
import { AssessmentRunner } from '@/app/dashboard/thrive/assessments/AssessmentRunner';
...
export default function PublicAssessmentPage() {
  ...
  const handleBack = () => router.push('/thrive');
    ...
    return (
      <NotBuilt>
        ...
        <p style={{ color: '#7a6a56', maxWidth: 380, margin: 0, lineHeight: 1.6 }}>
          <strong>{title}</strong> is not yet available. Check back soon.
        </p>
