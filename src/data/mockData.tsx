...
export const PROFESSIONAL_ASSESSMENTS: ProfessionalAssessment[] = [
  ...
  },
  {
    ...
    description: 'Tests your ability to break down complex problems systematically — from algorithmic reasoning and debugging logic to structured decision-making under constraints.',
    icon: LineChart,
    color: '#06b6d4',
    items: 40,
    questions: 40,
  ...
  },
  {
    ...
    description: 'Grounded in PMI standards, this assessment tests your mastery of the full project lifecycle — initiation, planning, execution, monitoring, and close-out — with scenario-based questions.',
    icon: Briefcase,
    color: '#10b981',
    items: 50,
    questions: 50,
  ...
  },
  {
    ...
    description: 'Emotional intelligence predicts job performance better than IQ in most roles. This assessment maps your self-awareness, empathy, emotional regulation, and social skill across 35 validated items.',
    icon: HeartHandshake,
    color: '#ec4899',
    items: 35,
    questions: 35,
  ...
  },
  {
    ...
    description: 'Diagnose your work habits, prioritization patterns, and focus strategies. Reveals where your time actually goes — and what high-performers do differently.',
    icon: Timer,
    color: '#f59e0b',
    items: 30,
    questions: 30,
...
export const PSYCHOLOGICAL_ASSESSMENTS: PsychologicalAssessment[] = [
  // Clinical Screening Tools (surfaced first — high value, quick, actionable)
  {
    id: 'gad-7',
    type: 'psychological',
    title: 'GAD-7 Anxiety Screening',
    description: 'The most widely used clinical tool for measuring generalized anxiety. Seven evidence-based questions — developed by Spitzer et al. — give you a validated severity score with established clinical cutoffs in under 3 minutes.',
    icon: Activity,
    color: '#ef4444',
    items: 7,
    questions: 7,
  ...
  },
  {
    ...
    description: 'The gold standard for depression screening in primary care. Nine DSM-5 aligned items quantify depressive symptom severity from minimal to severe — used in millions of clinical and research settings worldwide.',
    icon: CloudRain,
    color: '#64748b',
    items: 9,
    questions: 9,
  ...
  // Wellbeing & Strengths
  {
    ...
    description: "Developed by Martin Seligman, the PERMA Profiler measures the five pillars of psychological flourishing: Positive emotions, Engagement, Relationships, Meaning, and Achievement. Understand what's driving — or limiting — your overall wellbeing.",
    icon: Sun,
    color: '#fbbf24',
    items: 23,
    questions: 23,
  ...
  },
  {
    ...
    description: 'The most empirically supported personality model available. Measures Openness, Conscientiousness, Extraversion, Agreeableness, and Neuroticism across 60 items with international normative data — a foundation for understanding yourself.',
    icon: Brain,
    color: '#6366f1',
    items: 60,
    questions: 60,
  ...
  },
  {
    ...
    description: 'Used by 10+ million people worldwide, the VIA Survey reveals your top strengths from 24 universally valued character virtues. Rooted in positive psychology, it helps you understand what makes you distinctively you — and how to build on it.',
    icon: Trophy,
    color: '#10b981',
    items: 96,
    questions: 96,
  ...
  },
  {
    ...
    description: 'The definitive measure of occupational burnout. Explore your levels of emotional exhaustion, depersonalization, and personal accomplishment — essential self-knowledge for anyone navigating demanding work environments.',
    icon: BatteryLow,
    color: '#ea580c',
    items: 22,
    questions: 22,
  ...
  },
  {
    ...
    description: 'The CD-RISC is a validated 25-item measure of your capacity to adapt under pressure and recover from setbacks. Used in clinical, military, and occupational research — resilience is a skill, and this is how you measure it.',
    icon: Mountain,
    color: '#0891b2',
    items: 25,
    questions: 25,
  ...
  },
  {
    ...
    description: "The world's most widely used self-esteem measure. Ten straightforward statements — 5 minutes of honest reflection — backed by decades of cross-cultural research since Rosenberg's original 1965 work.",
    icon: Star,
    color: '#f59e0b',
    items: 10,
    questions: 10,
  ...
  {
    id: 'self-compassion-scale',
    type: 'psychological',
    title: 'Self-Compassion Scale (Short Form)',
    description: "Kristin Neff's SCS-SF measures how you treat yourself in moments of failure and difficulty. Research consistently shows self-compassion predicts emotional resilience, motivation, and wellbeing — often better than self-esteem alone.",
    icon: Heart,
    color: '#ec4899',
    items: 12,
    questions: 12,
    ...
    disclaimerRequired: false,
    status: 'coming_soon',
    publisher: 'Neff et al.'
  },
  {
    id: 'dass-21',
    type: 'psychological',
    title: 'DASS-21 (Depression, Anxiety & Stress)',
    description: 'The short form of the DASS scales — 21 items measuring three distinct negative emotional states. Widely used in research and clinical monitoring to track psychological health across all three dimensions simultaneously.',
    icon: Gauge,
    color: '#dc2626',
    items: 21,
    questions: 21,
...
export const CREATIVITY_ASSESSMENTS: CreativityAssessment[] = [
  {
    ...
    type: 'creativity',
    title: 'Cognitive Reflection Test (Extended)',
    description: 'Do you trust your gut or interrogate it? The CRT measures your tendency to override snap intuitions in favor of deliberate reasoning — a strong predictor of rational decision-making and analytical depth.',
    icon: BookOpen,
    color: '#c084fc',
    items: 10,
    questions: 10,
  ...
  },
  {
    ...
    description: "Mednick's classic test of creative insight: find the single word that connects three seemingly unrelated words. Measures the 'aha!' moment — your ability to spot non-obvious connections between distant concepts.",
    icon: Puzzle,
    color: '#818cf8',
    items: 40,
    questions: 40,
  ...
  },
  {
    ...
    description: 'How well do you see the whole picture? This assessment evaluates your ability to recognize feedback loops, unintended consequences, and emergent patterns — a critical skill in design, strategy, and leadership.',
    icon: TrendingUp,
    color: '#60a5fa',
    items: 28,
    questions: 28,
  ...
  },
  {
    ...
    description: 'Inspired by Torrance\'s foundational research, this assessment measures the four dimensions of creative thinking: fluency (how many ideas), flexibility (how varied), originality (how novel), and elaboration (how detailed).',
    icon: Lightbulb,
    color: '#fbbf24',
    items: 30,
    questions: 30,
  ...
  },
  {
    ...
    description: 'Creativity at work is more than ideas — it\'s ideas that get built. This scale measures all three phases: idea generation, championing your ideas within a team, and actually implementing them.',
    icon: Zap,
    color: '#a855f7',
    items: 32,
    questions: 32,
  ...
  },
  {
    id: 'design-thinking',
    type: 'creativity',
    title: 'Design Thinking Mindset Assessment',
    description: 'Measures how naturally you approach problems through empathy, reframing, rapid prototyping, and iteration. Assess your fluency across all five phases of the design thinking process — from empathize to test.',
    icon: Palette,
    color: '#f472b6',
    items: 35,
    questions: 35,
    ...
    category: 'Creativity',
    domain: 'practical',
    scoringMethod: 'Phase-based profiling',
    status: 'coming_soon'
  },
  {
    id: 'lateral-thinking',
    type: 'creativity',
    title: 'Lateral Thinking Test',
    description: "Inspired by Edward de Bono's work on parallel and lateral thinking, this assessment challenges you to escape conventional problem frames and approach constraints from unexpected angles — the essence of creative disruption.",
    icon: PenTool,
    color: '#34d399',
    items: 25,
    questions: 25,
    ...
    category: 'Creativity',
    domain: 'divergent',
    scoringMethod: 'Pattern-breaking index',
    status: 'coming_soon'
  }
];
