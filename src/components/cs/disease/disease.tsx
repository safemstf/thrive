...
import { 
  Activity, PlayCircle, PauseCircle, RefreshCw, TrendingUp, 
  TrendingDown, AlertTriangle, Shield, Users, Heart,
...
// ============================================================================
// STYLED COMPONENTS - YouTube-like Layout
// ============================================================================
...
const HUD = styled.div<{ $isDark?: boolean }>`
  position: absolute;
  top: 1rem;
  left: 1rem;
...
const ControlsSection = styled.div<{ $isDark?: boolean }>`
  padding: 1.5rem;
  background: ${({ $isDark }) => 
...
const StatCard = styled.div<{ $color?: string; $alert?: boolean }>`
  padding: 1rem;
...
type SimulationMode = 'homogeneous' | 'regions' | 'households';
